...
class AlienInvasion():
    ...
    def _create_fleet(self):
        ...
        available_space_y = self.settings.height - (2 * alien_height) - ship_height
    ...
    def _create_rain(self):
        rain = Rain(self)
        space = self.ship.rect.width
        number_rain = self.settings.width // space
        for rain_number in range(number_rain):
            rain = Rain(self)
            rain.rect.x = space * rain_number
            self.rains.add(rain)
